...
contract DeferredEquityPlan {
    ...
    // initalize fakenow for testing purpose, to forward time by 100 days
    uint fakenow = now;
    ...
    function distribute() public hrOREmployee {
        ...
        require(unlock_time <= fakenow, "Shares can not be distributed at this time, please wait for Shares to vest");
        ...
        distributed_shares = uint16((fakenow - start_time) / 365 days * annual_distribution);
    ...
    // fastforward now (fakenow) by 100 days, used for testing purpose ONLY
